...
> **Важно:** Этот репозиторий содержит только конфигурацию развёртывания. Для работы необходимы лицензионные MCP-серверы, которые приобретаются отдельно: [vibecoding1c.ru/mcp_server](https://vibecoding1c.ru/mcp_server)
